...
// exsc is a shortcut for creating a styled component
...
export const QuoteGeneratorTitle = styled.div`
  ...
  position: relative;
  /* MEDIA QUERY: if the screen has a max size of 600 pixels, the font size decreases */
...
// we could be using a button, but using a div gives you more granulaity and control
export const GenerateQuoteButton = styled.div`
  ...
  border-radius: 10px;
  border: 1px solid rgba(255, 255, 255, 0.18);
  /* on hover effects for styled components */
  &:hover {
    filter: brightness(3);
    transition: 0.2s all ease-in-out;
    transform: scale(1.1);
